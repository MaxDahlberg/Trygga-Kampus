    ...
    Box(
        ...
        MainContent(
            modifier = Modifier
                ...
                .scale(animatedScale)
                .coloredShadow(Color.Black, alpha = 0.1f, shadowRadius = 50.dp),
...
fun MainContent(
    ...
    Scaffold(
        ...
        topBar = { AppBar(onNavigationIconClick = { onDrawerClick(drawerState.opposite()) }) },
            ...
            if (drawerState == CustomDrawerState.Opened) {
                Column(
                    modifier = Modifier
                        ...
                        .clickable { onDrawerClick(CustomDrawerState.Closed) },
                    content = {}
                )
            }
        }
